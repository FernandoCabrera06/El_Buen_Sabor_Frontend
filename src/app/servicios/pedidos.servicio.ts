...
export class PedidoServicio {
  ...
  getPedidosFromDataBase(): Observable<PedidoDto[]> {
    return this.http.get<PedidoDto[]>(
      'http://localhost:8080/pedido/listarPedidos'
    );
  }
  ...
  getPedidosPorUsuario(fechaDesde: string, fechaHasta: string) {
    return this.http
      .get(
        'http://localhost:8080/pedido/pedidosPorUsuario?fecha1=' +
          fechaDesde +
          '&fecha2=' +
          fechaHasta
      )
      .pipe(map((pedidosData) => pedidosData));
  }
  ...
  getPedidosPorFechas(fechaDesde: string, fechaHasta: string) {
    return this.http
      .get(
        'http://localhost:8080/pedido/pedidosPorFechas?fecha1=' +
          fechaDesde +
          '&fecha2=' +
          fechaHasta
      )
  ...
  getPedidosPorUsuarioFromDataBase(
    nombreUsuario: any
  ): Observable<PedidoDto[]> {
    return this.http.get<PedidoDto[]>(
      'http://localhost:8080/pedido/listarPedidosPorUsuario?nombreUsuario=' +
        nombreUsuario
    );
  }
}
