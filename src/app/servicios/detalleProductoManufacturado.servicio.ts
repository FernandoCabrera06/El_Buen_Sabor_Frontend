...
export class detalleProductoManufactuardoServicio{
  ...
  private producto: BehaviorSubject<ArticuloManufacturado> = new BehaviorSubject<ArticuloManufacturado>(this.articulo);
  private bebida: BehaviorSubject<Bebida> = new BehaviorSubject<Bebida>(this.articuloBebida);

  constructor(){}

  public producto$: Observable<ArticuloManufacturado> = this.producto.asObservable();
